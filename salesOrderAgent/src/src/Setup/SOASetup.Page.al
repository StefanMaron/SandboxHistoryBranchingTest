    ...
    layout
    {
        area(Content)
        {
            ...
            group(MonitorIncomingCard)
            {
                ...
                {
                    Visible = FirstConfig;
                    InstructionalText = 'By enabling the Sales Order Agent, you understand your organization may be billed for its use in the future.';
                    Caption = 'Important';
                ...
                group(BillingInformationSecondSetup)
                {
                    ...
                    InstructionalText = 'In the future your organization may be billed for use of the Sales Order Agent.';
                    Caption = 'Important';
            ...
            group(RespondToInquiriesCard)
            {
                ...
                {
                    ShowCaption = false;
                    field(ItemSearchLbl; ItemSearchLbl)
                    {
                        ShowCaption = false;
                    }
