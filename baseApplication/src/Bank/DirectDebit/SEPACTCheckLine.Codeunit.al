...
codeunit 1223 "SEPA CT-Check Line"
{
    ...
    begin
        ...
        if (not IsNorgeExport) and (GenJnlLine."Currency Code" <> GLSetup.GetCurrencyCode('EUR')) and (not GLSetup."SEPA Non-Euro Export") then begin
        ...
        if IsNorgeExport then begin
            ...
            if GenJnlLineRegRepCode.Count > 10 then
                GenJnlLine.InsertPaymentFileError(ALotOfRegRepCodesNotAllowedErr);
        end;
