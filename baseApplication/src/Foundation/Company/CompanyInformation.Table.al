...
#if not CLEAN23
    [Obsolete('The procedure is obsoleted, directly access the field "Registered Home City" instead', '23.0')]
    procedure GetLegalOffice(): Text
    begin
        exit("Registered Home City");
    end;

    [Obsolete('The procedure is obsoleted, directly access the field "Registered Home City"''s Caption instead', '23.0')]
